[![Build Status](https://travis-ci.org/jgeorgex/GildedRose-Refactoring-Kata.svg?branch=master)](https://travis-ci.org/jgeorgex/GildedRose-Refactoring-Kata)
...
To solve this I have taken the documented requirements and started to make them in to tests.
Each tested requirement is added as a comment above the tests.

The tests are to ensure that the program is behaving as expected.  

When I have completed writing the tests I will then refactor one element at a time using the tests as confirmation that the state of the program has not changed.
